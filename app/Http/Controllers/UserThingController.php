...
class UserThingController extends Controller
{
    ...
    {
        return Inertia::render('User/UserThings', [
            'filters' => FRequest::all('search', 'category'),
            'data' => Thing::with('user')
            ->orderBy('things.id', 'desc') // consider using ->latest() which is equivalent to ->orderBy('created_at', 'desc')
    ...
    {
        return Inertia::render('User/UserThingsCreate');
    }
