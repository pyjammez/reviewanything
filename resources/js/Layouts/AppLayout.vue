                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('home')">
                                    <small>REVIEW</small><br /><strong>ANYTHING</strong>
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('things.index')" :active="route().current('things.index')">
                                    Things
                                </jet-nav-link>
                            </div>
                            ...
                            <div class="ml-3 relative">
                                <jet-dropdown align="right" width="48" v-if="$page.props.user">
                                    ...
                                    <template #content>
                                        ...
                                        <jet-dropdown-link :href="route('admin-dashboard')"> Dashboard </jet-dropdown-link>
                                        <jet-dropdown-link :href="route('admin.reviews.index')"> Reviews </jet-dropdown-link>
                                        <jet-dropdown-link :href="route('admin.things.index')"> Things </jet-dropdown-link>
                                        <jet-dropdown-link :href="route('admin.users.index')"> Users </jet-dropdown-link>
                                        <jet-dropdown-link :href="route('admin.organizations.index')"> Organizations </jet-dropdown-link>
                                        
                                        <!-- Account Management -->
                                        <div class="block px-4 py-2 text-xs text-gray-400"> Manage Account </div>
                                        <jet-dropdown-link :href="route('user-dashboard')"> Dashboard </jet-dropdown-link>
                                        <jet-dropdown-link :href="route('user.reviews.index')"> Reviews </jet-dropdown-link>
                                        <jet-dropdown-link :href="route('user.things.index')"> Things </jet-dropdown-link>
