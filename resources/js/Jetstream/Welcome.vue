    ...
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            ...
            <div class="mt-6 text-gray-500">
                Laravel poostream provides a beautiful, robust starting point for your next Laravel application. Laravel is designed
            ...
            <div class="p-6">
                ...
                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        Laravel fuck offf this is the jet stream wlcome vuet of the framework. Whether you're new to the framework or have previous experience, we recommend reading all of the documentation from beginning to end.
                    </div>
